...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#001037] relative min-h-[40vh] w-full md:px-[6rem] px-[1.5rem] py-[2.5rem] ">
      {/* image section */}

      <section className="top flex items-center justify-between md:flex-row flex-col gap-[2.8rem] md:gap-[4rem]">
        <div className="item_container md:w-[50%] w-full">
          <div className="footer_svg absolute -z-5 top-0 left-0 md:block hidden">
            <img src="/svgs/footer.svg" alt="" />
          </div>
          <div className="first_container z-50">
            ...
            <a
              ...
              className="text-white mb-[1rem] block"
            >
              +234-816-152-5556
            </a>
            ...
            <a
              href="mailto:kioskhivewholesales@gmail.com"
        ...
        <div className="second_container md:w-[50%] w-full flex items-center flex-wrap justify-start gap-[2rem] h-full">
          {footerData.map((item) => (
      ...
      <section className="item_container mt-[3rem]">
        <div className="line w-full bg-[#333333] mb-[4rem] h-[.1rem]"></div>
