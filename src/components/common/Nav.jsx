...
const Nav = ({ active }) => {
  ...
  return (
    <header className="w-full flex items-center justify-between md:px-[4rem] border-b-[.2px] border-gray-200 px-[1rem] min-h-[5rem] fixed top-0 left-0 z-[500] bg-white bg-opacity-40 backdrop-blur-[10px] shadow-md">
